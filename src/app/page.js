...
export default function Home() {
  return (
    ...
    <Hero />
      ...
      <KioskScrollSection prefix ="ezgif-frame" frameCount = "42"  folder = "/assets/kiosk/"   frameExt = "webp" data={{heading:"Self-Service Kiosks & ATMs",description:"Empower your customers; when, how and where they want.",buttonText:"Discover how it works"}} value={3}/>
