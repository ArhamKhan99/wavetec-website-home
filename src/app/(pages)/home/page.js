...
export default function Home() {
  return (
    ...
    <Hero />
      ...
      <KioskScrollSection prefix ="block2" frameCount = "551"  folder = "/assets/"  frameExt = "webp" data={{heading:"Self-Service Kiosks & ATMs",description:"Empower your customers; when, how and where they want.",buttonText:"Discover how it works"}} />
